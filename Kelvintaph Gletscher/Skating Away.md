# Level Nummer: 13 - Skating Away

![Screenshot of the level](welt5-level13.png)
...
while(true) {
    ...
    if(distance < 10) {
        ...
        var vector = Vector.subtract(hero.pos, yak.pos);
        // Now use Vector.normalize and Vector.multiply to make it 10m long
        vector = Vector.multiply(Vector.normalize(vector), 10);
